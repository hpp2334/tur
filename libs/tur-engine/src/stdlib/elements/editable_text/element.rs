...
use crate::stdlib::keyboard::KeydownEvent;
use crate::stdlib::text::TextEditingController;
...
use crate::stdlib::elements::text::span_data::SpanData;
...
impl EditableTextElement {
    ...
    pub fn undo_controller_mut(&self) -> Option<boa_engine::object::RefMut<'_, crate::stdlib::text::UndoController>> {
        self.view
            .undo_controller
            .as_ref()?
            .downcast_mut::<crate::stdlib::text::UndoController>()
    }
    ...
    fn handle_key_event(
        ...
        let handled = match key {
            ...
            "z" if (ctrl || meta) && self.view.undo_controller.is_some() => {
                ...
                use crate::stdlib::text::TextEditingValue;
...
impl EditableTextView {
    ...
    pub fn from_js(props: &JsObject, ctx: &mut Context) -> Self {
        ...
        EditableTextView {
            ...
            undo_controller: p.opaque::<crate::stdlib::text::UndoController>("undoController"),
