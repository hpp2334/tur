//! The 8 enum const-objects exported by `builtin:tur/core` (Axis,
...
use crate::core::bridge::helpers::ConstEntry;
...
pub(crate) fn consts(context: &mut Context) -> Vec<ConstEntry> {
    vec![
