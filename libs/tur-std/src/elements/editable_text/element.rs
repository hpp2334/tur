...
impl EditableTextElement {
    ...
    pub fn undo_controller_mut(&self) -> Option<boa_engine::object::RefMut<'_, crate::text::UndoController>> {
        self.view
            .undo_controller
            .as_ref()?
            .downcast_mut::<crate::text::UndoController>()
    }
    ...
    fn handle_key_event(
        ...
        let handled = match key {
            ...
            "z" if (ctrl || meta) && self.view.undo_controller.is_some() => {
                ...
                use crate::text::TextEditingValue;
