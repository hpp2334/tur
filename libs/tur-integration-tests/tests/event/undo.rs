...
const UNDO_INPUT_BUNDLE: &str = r#"
    import { createTextEditingController, createUndoController, setViewRoot, viewRoot, Container, Input } from "tur:std";
...
const PLAYGROUND_BUNDLE: &str = r#"
    import { mutate, createTextEditingController, createUndoController, setViewRoot, viewRoot, Container, Input } from "tur:std";
