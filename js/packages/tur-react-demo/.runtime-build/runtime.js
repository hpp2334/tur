...
760(module, __unused_rspack_exports, __webpack_require__) {
/**
 * @license React
...
module.exports = function ($$$config) {
  ...
  var React = __webpack_require__(348),
    Scheduler = __webpack_require__(37),
...
44(module, __unused_rspack_exports, __webpack_require__) {
...
773(__unused_rspack_module, exports) {
/**
 * @license React
 * react.production.js
 *
...
348(module, __unused_rspack_exports, __webpack_require__) {
...
520(__unused_rspack_module, exports) {
/**
 * @license React
...
37(module, __unused_rspack_exports, __webpack_require__) {
...
(() => {
// NAMESPACE OBJECT: ../tur-react-renderer/dist/index.js
var dist_namespaceObject = {};
__webpack_require__.r(dist_namespaceObject);
__webpack_require__.d(dist_namespaceObject, { 
  Axis: () => (Axis_Axis),
  BorderPosition: () => (BorderPosition_BorderPosition),
  BoxFit: () => (BoxFit_BoxFit),
  Color: () => (Color),
  CrossAxisAlignment: () => (CrossAxisAlignment_CrossAxisAlignment),
  FlexDirection: () => (FlexDirection_FlexDirection),
  FlexFit: () => (FlexFit_FlexFit),
  HitTestBehavior: () => (HitTestBehavior_HitTestBehavior),
  LinearGradient: () => (LinearGradient),
  MainAxisAlignment: () => (MainAxisAlignment_MainAxisAlignment),
  MainAxisSize: () => (MainAxisSize_MainAxisSize),
  StackFit: () => (StackFit_StackFit),
  createImageResource: () => (createImageResource),
  createSvgResource: () => (createSvgResource),
  createTextEditingController: () => (createTextEditingController),
  renderRoot: () => (renderRoot) });

// NAMESPACE OBJECT: ../tur-react/dist/index.js
var tur_react_dist_namespaceObject = {};
__webpack_require__.r(tur_react_dist_namespaceObject);
__webpack_require__.d(tur_react_dist_namespaceObject, { 
  Axis: () => (Axis_Axis),
  BorderPosition: () => (BorderPosition_BorderPosition),
  BoxFit: () => (BoxFit_BoxFit),
  Color: () => (Color),
  ...
  MainAxisSize: () => (MainAxisSize_MainAxisSize),
  Paragraph: () => (Paragraph),
  PointerInteract: () => (PointerInteract),
...
// NAMESPACE OBJECT: ../../node_modules/.pnpm/jotai@2.20.0_@types+react@19.2.14_react@19.2.6/node_modules/jotai/esm/vanilla.mjs
var vanilla_namespaceObject = {};
__webpack_require__.r(vanilla_namespaceObject);
__webpack_require__.d(vanilla_namespaceObject, { 
  INTERNAL_overrideCreateStore: () => (INTERNAL_overrideCreateStore),
  atom: () => (vanilla_atom),
  createStore: () => (createStore),
  getDefaultStore: () => (getDefaultStore) });

// NAMESPACE OBJECT: ../../node_modules/.pnpm/jotai@2.20.0_@types+react@19.2.14_react@19.2.6/node_modules/jotai/esm/react.mjs
var esm_react_namespaceObject = {};
__webpack_require__.r(esm_react_namespaceObject);
__webpack_require__.d(esm_react_namespaceObject, { 
  Provider: () => (Provider),
  useAtom: () => (useAtom),
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/react-reconciler@0.31.0_react@19.2.6/node_modules/react-reconciler/index.js
var react_reconciler = __webpack_require__(44);
;// CONCATENATED MODULE: ../tur-react-renderer/dist/index.js
...
class Color {
    ...
    static hex(hex) {
        const h = hex.replace(/^#/, "");
        if (3 === h.length) return new Color(parseInt(h[0] + h[0], 16), parseInt(h[1] + h[1], 16), parseInt(h[2] + h[2], 16), 255);
        if (6 === h.length) return new Color(parseInt(h.slice(0, 2), 16), parseInt(h.slice(2, 4), 16), parseInt(h.slice(4, 6), 16), 255);
        if (8 === h.length) return new Color(parseInt(h.slice(0, 2), 16), parseInt(h.slice(2, 4), 16), parseInt(h.slice(4, 6), 16), parseInt(h.slice(6, 8), 16));
        throw new Error(`Invalid hex color: ${hex}`);
    }
}
var Axis_Axis = /*#__PURE__*/ function(Axis) {
    Axis[Axis["Vertical"] = 0] = "Vertical";
    Axis[Axis["Horizontal"] = 1] = "Horizontal";
    return Axis;
}({});
var BorderPosition_BorderPosition = /*#__PURE__*/ function(BorderPosition) {
    BorderPosition[BorderPosition["Inside"] = 0] = "Inside";
    BorderPosition[BorderPosition["Center"] = 1] = "Center";
    BorderPosition[BorderPosition["Outside"] = 2] = "Outside";
    return BorderPosition;
}({});
var BoxFit_BoxFit = /*#__PURE__*/ function(BoxFit) {
    BoxFit[BoxFit["Fill"] = 0] = "Fill";
    BoxFit[BoxFit["Contain"] = 1] = "Contain";
    BoxFit[BoxFit["Cover"] = 2] = "Cover";
    BoxFit[BoxFit["FitWidth"] = 3] = "FitWidth";
    BoxFit[BoxFit["FitHeight"] = 4] = "FitHeight";
    BoxFit[BoxFit["None"] = 5] = "None";
    return BoxFit;
}({});
var CrossAxisAlignment_CrossAxisAlignment = /*#__PURE__*/ function(CrossAxisAlignment) {
...
var FlexDirection_FlexDirection = /*#__PURE__*/ function(FlexDirection) {
    FlexDirection[FlexDirection["Vertical"] = 0] = "Vertical";
    FlexDirection[FlexDirection["Horizontal"] = 1] = "Horizontal";
    return FlexDirection;
}({});
var FlexFit_FlexFit = /*#__PURE__*/ function(FlexFit) {
    FlexFit[FlexFit["Tight"] = 0] = "Tight";
    FlexFit[FlexFit["Loose"] = 1] = "Loose";
    return FlexFit;
}({});
var HitTestBehavior_HitTestBehavior = /*#__PURE__*/ function(HitTestBehavior) {
    HitTestBehavior[HitTestBehavior["Opaque"] = 0] = "Opaque";
    HitTestBehavior[HitTestBehavior["Translucent"] = 1] = "Translucent";
    return HitTestBehavior;
}({});
var MainAxisAlignment_MainAxisAlignment = /*#__PURE__*/ function(MainAxisAlignment) {
...
var MainAxisSize_MainAxisSize = /*#__PURE__*/ function(MainAxisSize) {
    MainAxisSize[MainAxisSize["Max"] = 0] = "Max";
    MainAxisSize[MainAxisSize["Min"] = 1] = "Min";
    return MainAxisSize;
}({});
var StackFit_StackFit = /*#__PURE__*/ function(StackFit) {
    StackFit[StackFit["Loose"] = 0] = "Loose";
    StackFit[StackFit["Expand"] = 1] = "Expand";
    StackFit[StackFit["Passthrough"] = 2] = "Passthrough";
    return StackFit;
}({});
function createImageResource(data) {
...
function setProps(handle, props, previousProps) {
    for(const key in props){
        if ("children" === key || "key" === key || "ref" === key) continue;
        const value = props[key];
        const prev = previousProps?.[key];
        if (null == value) {
            if (null != prev) __tur.setAttribute(ctx, handle, key, null);
        } else __tur.setAttribute(ctx, handle, key, value);
    }
}
let updatePriority = 0;
const reconciler = react_reconciler({
    ...
    supportsMicrotasks: "function" == typeof queueMicrotask,
    scheduleMicrotask: "function" == typeof queueMicrotask ? (cb)=>queueMicrotask(cb) : void 0,
...
function renderRoot(component) {
    ...
    _container = reconciler.createContainer(root, 0, null, false, null, "", handleError, handleError, handleError, ()=>{});
...
function createSvgResource(svgString) {
    return __tur.createSvgResource(__tur.__ctx, svgString);
}
function createTextEditingController(options) {
    return __tur.createTextEditingController(__tur.__ctx, options);
}


;// CONCATENATED MODULE: ../tur-react/dist/index.js
...
function Expanded(props) {
    return /*#__PURE__*/ react.createElement("tur_flex_item", {
        flex: props.flex,
        fit: props.fit,
...
function Stack(props) {
    return /*#__PURE__*/ react.createElement("tur_stack", {
        fit: props.fit,
        queryKey: props.queryKey
    }, props.children);
}
function Positioned(props) {
    return /*#__PURE__*/ react.createElement("tur_positioned", {
        left: props.left,
        top: props.top,
        right: props.right,
        bottom: props.bottom,
...
function SizedBox(props) {
    return /*#__PURE__*/ react.createElement("tur_container", {
        width: props.width,
        height: props.height,
        queryKey: props.queryKey
    }, props.children);
...
function PointerInteract(props) {
    return /*#__PURE__*/ react.createElement("tur_pointer_interact", {
...
function Focusable(props) {
    ...
    return /*#__PURE__*/ react.createElement("tur_focusable", {
        ref: ref,
        onFocus: onFocus,
        onBlur: onBlur,
        onKeyDown: onKeyDown,
...
function Paragraph(props) {
    return /*#__PURE__*/ react.createElement("tur_paragraph", {
        spans: props.spans,
...
function Input(props) {
    ...
    return /*#__PURE__*/ react.createElement("tur_container", {
        width: props.width,
        height: props.height
    }, /*#__PURE__*/ react.createElement("tur_editable_text", {
        ref: (el)=>ctrl._attach(el),
        controller: ctrl,
...
function Image(props) {
    return /*#__PURE__*/ react.createElement("tur_image", {
        resourceId: props.resource,
        width: props.width,
        height: props.height,
        fit: props.fit ?? BoxFit_BoxFit.Contain,
        queryKey: props.queryKey
    });
}
function Svg(props) {
    return /*#__PURE__*/ react.createElement("tur_svg", {
        resourceId: props.resource,
        width: props.width,
        height: props.height,
        fit: props.fit ?? BoxFit_BoxFit.Contain,
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/jotai@2.20.0_@types+react@19.2.14_react@19.2.6/node_modules/jotai/esm/vanilla/internals.mjs
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/jotai@2.20.0_@types+react@19.2.14_react@19.2.6/node_modules/jotai/esm/vanilla.mjs
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/jotai@2.20.0_@types+react@19.2.14_react@19.2.6/node_modules/jotai/esm/react.mjs
'use client';
    ...
    continuablePromise = new Promise((resolve, reject) => {
      ...
      const onAbort = () => {
        try {
          ...
          if (react_isPromiseLike(nextValue)) {
