                    ...
                    Row({
                        ...
                        children: [
                            Pill({
                                ...
                                onClick: mutate(() => { set(aspect$, 1); }),
                            }),
                            SizedBox({ width: 6 }),
                            Pill({
                                label: "Wide",
                                active: derive(() => get(aspect$) > 1),
                                onClick: mutate(() => { set(aspect$, 2); }),
                            }),
                            SizedBox({ width: 6 }),
                            Pill({
                                label: "Tall",
                                active: derive(() => get(aspect$) < 1),
                                onClick: mutate(() => { set(aspect$, 0.5); }),
                            }),
                        ],
                    }),
                    SizedBox({ height: 8 }),
                    Row({
                        ...
                        children: [
                            Pill({
                                ...
                                onClick: mutate(() => { set(dense$, false); }),
                            }),
                            SizedBox({ width: 6 }),
                            Pill({
                                label: "Dense",
                                active: derive(() => get(dense$)),
                                onClick: mutate(() => { set(dense$, true); }),
                            }),
                        ],
                    }),
                    SizedBox({ height: 12 }),
                        ...
                        child: Container({
                            ...
                            children: [
                                LazyGrid({
                                    ...
                                    maxCrossAxisExtent: derive(() => (get(dense$) ? 85 : 140)),
                                    ...
                                    builder: (i: number) => {
                                        const hue = (i * 37) % 360;
                                        return Container({
                                            color: Color.hex(hslToHex(hue, 52, 48)),
                                            children: [
                                                Text({
                                                    text: `${i}`,
                                                    fontSize: 10,
