...
function Card(expanded$: Readable<boolean>): Element {
    return Stack()
        .children([
            ...
            Container().width(340).height(220).build(),
            AnimatedPositioned()
                ...
                .child(
                    AnimatedOpacity()
                        .value(
                            derive((ctx) => (ctx.get(expanded$) ? 1.0 : 0.45)),
                        )
                        .duration(DURATION)
                        .curve("easeInOut")
                        .child(
...
function ToggleButton(
    ...
    return MouseRegion()
        ...
        .child(
            PointerInteract()
                .onClick(
                    toggle as unknown as Mutation<[PointerInteractEvent], void>,
                )
                .child(
                    Container()
                        .padding(10)
