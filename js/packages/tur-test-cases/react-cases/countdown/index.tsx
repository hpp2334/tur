...
function Countdown() {
  ...
  return (
    <Container padding={16} queryKey={["root"]}>
      <Column>
        <Text content={`Countdown: ${remaining}`} queryKey={["display"]} />
        <Row mainAlignment={MainAxisAlignment.Start} crossAlignment={CrossAxisAlignment.Start}>
          <PointerInteract onClick={openEdit} child={
            <Container padding={8} queryKey={["btn-edit"]}>
              <Text content="Edit" />
            </Container>
          } />
          <PointerInteract onClick={start} child={
            <Container padding={8} queryKey={["btn-start"]}>
              <Text content="Start" />
            </Container>
          } />
          <PointerInteract onClick={pause} child={
            <Container padding={8} queryKey={["btn-pause"]}>
              <Text content="Pause" />
            </Container>
          } />
          <PointerInteract onClick={reset} child={
        ...
        {editing && (
          <Container padding={16} queryKey={["modal"]}>
            <Column>
              ...
              <PointerInteract onClick={confirmEdit} child={
                <Container padding={8} queryKey={["btn-confirm"]}>
