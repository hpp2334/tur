...
const INITIAL_TODOS: readonly Todo[] = [
    ...
    {
        id: 2,
        text: "Build tur engine",
        done: false,
        description: "Implement the rendering engine with winit and vello",
    },
    {
        id: 3,
        text: "Write documentation",
        done: false,
        description: "Document the architecture and API surface",
    },
    {
        id: 4,
        text: "Ship v0.1.0",
...
export const addTodoAtom = atom(
    null,
    (_get, set, payload: { text: string; description: string }) => {
